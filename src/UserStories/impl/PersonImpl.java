 ...
 * </p>
 * <ul>
 *   <li>{@link UserStories.impl.PersonImpl#getUserstories <em>Userstories</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PersonImpl extends MinimalEObjectImpl.Container implements Person {
	/**
	 * The cached value of the '{@link #getUserstories() <em>Userstories</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getUserstories()
	 * @generated
	...
	protected EClass eStaticClass() {
		return UserStoriesPackage.Literals.PERSON;
	}
	...
	public EList<UserStory> getUserstories() {
		if (userstories == null) {
			userstories = new EObjectWithInverseResolvingEList<UserStory>(UserStory.class, this, UserStoriesPackage.PERSON__USERSTORIES, UserStoriesPackage.USER_STORY__PERSON);
		}
		return userstories;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case UserStoriesPackage.PERSON__USERSTORIES:
